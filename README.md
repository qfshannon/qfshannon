...
- **Project #3:** Create an interactive app that allows users to explore how different parameters influence K-Nearest Neoghbors model perfomance on a dataset of their choosing. Access the project using [this link](https://github.com/qfshannon/Shannon-Data-Science-Portfolio/tree/main/MLStreamlitApp).
<p align="center">
